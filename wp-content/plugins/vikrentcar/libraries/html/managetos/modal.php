		...
		<div class="vrc-admin-container vrc-params-container-wide">
			...
			<div class="vrc-params-container">
				...
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo JText::translate('VRPVIEWCUSTOMFONE'); ?> <sup>*</sup></div>
				...
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo JText::translate('VRNEWCUSTOMFEIGHT'); ?> <sup>*</sup></div>
					<div class="vrc-param-setting">
