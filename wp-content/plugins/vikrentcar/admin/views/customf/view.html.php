...
class VikRentCarViewCustomf extends JViewVikRentCar {
	...
	protected function addToolBar() {
		...
		if (JFactory::getUser()->authorise('core.create', 'com_vikrentcar')) {
			JToolBarHelper::addNew('newcustomf', JText::translate('VRMAINCUSTOMFNEW'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikrentcar')) {
			JToolBarHelper::editList('editcustomf', JText::translate('VRMAINCUSTOMFEDIT'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentcar')) {
			JToolBarHelper::deleteList(JText::translate('VRCDELCONFIRM'), 'removecustomf', JText::translate('VRMAINCUSTOMFDEL'));
			JToolBarHelper::spacer();
		}
	}
