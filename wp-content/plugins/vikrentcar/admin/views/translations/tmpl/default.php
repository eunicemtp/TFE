...
<form action="index.php?option=com_vikrentcar&amp;task=translations" method="post" onsubmit="return vrcCheckChanges();">
	...
	if (!empty($active_table_key)) {
		...
		<div class="btn-group pull-left">
			<input type="text" name="keysearch" value="<?php echo JHtml::fetch('esc_attr', $keysearch); ?>" placeholder="<?php echo JHtml::fetch('esc_attr', JText::translate('VRCDASHSEARCHKEYS')); ?>..." />
		</div>
		<?php
	}
	?>
...
if (VRCPlatformDetection::isJoomla()) {
	...
	?>
		<div class="vrc-translation-langcontent" style="display: none;" id="vrc_langcontent_ini">
			<fieldset class="adminform">
				<legend class="adminlegend">.INI <?php echo JText::translate('VRCTRANSLATIONINISTATUS'); ?></legend>
				<div class="vrc-translations-tab-container">
				<?php
				foreach ($all_inis as $initype => $inidet) {
					...
					<div class="vrc-translations-ini-element">
						<div class="vrc-translations-element-title">
							<div class="vrc-translate-element-cell"><?php echo JText::translate('VRCINIEXPL'.strtoupper($initype)); ?></div>
						</div>
						<div class="vrc-translations-element-contents">
					<?php
					foreach ($langs as $ltag => $lang) {
						...
						?>
							<div class="vrc-translations-element-row <?php echo $t_file_exists ? 'vrc-field-translated' : 'vrc-missing-translation'; ?>">
								...
								<div class="vrc-translations-element-val">
									<span class="vrc-inifile-totrows <?php echo $t_file_exists ? 'vrc-inifile-exists' : 'vrc-inifile-notfound'; ?>"><?php echo $t_file_exists && $t_parsed_ini !== false ? JText::translate('VRCINIDEFINITIONS').': '.count($t_parsed_ini) : JText::translate('VRCINIMISSINGFILE'); ?></span>
									<span class="vrc-inifile-path <?php echo $t_file_exists ? 'vrc-inifile-exists' : 'vrc-inifile-notfound'; ?>"><?php echo JText::translate('VRCINIPATH').': '.str_replace('en-GB', $ltag, $inipath); ?></span>
								</div>
							</div>
						<?php
					}
